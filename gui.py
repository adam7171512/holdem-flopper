...
class FlopperGui(tk.Tk):
    ...
    def create_widgets(self):
        ...
        negation_box = ttk.Checkbutton(logical_frame, text="NOT", variable=self.filter_negation_clicked, onvalue=1, offvalue=0)
        negation_box.grid(column=1, row=4, columnspan=2)

        add_filter_button = ttk.Button(self, text="ADD FILTER", command="")
